...
const ComicDetails = () => {
    ...
    const handleFavoriteClick = () => {
        ...
        console.log(isFavorite ? "Cómic quitado de favoritos" : "Cómic añadido a favoritos");
    };
                ...
                <div className="comic-details-header">
                    ...
                    <div className="comic-info">
                        ...
                        <div className="comic-tags">
                            <div className="tag">
                                <div className="tag-title">Edición</div><span>{edition}</span>
                            </div>
                            <div className="tag">
                                <div className="tag-title">Estado</div><span>{status}</span>
                            </div>
                            <div className="tag">
                                <div className="tag-title">Editorial</div><span>{publisher}</span>
                            </div>
                            <div className="tag">
                                <div className="tag-title">Precio Ref.</div><span>${price} MXN</span>
                            </div>
                        </div>
                        <p className="comic-description">{description}</p>
                        <p className="comic-creators">
                            Creadores: {creators.length > 0 ? creators.join(", ") : "No disponibles"}
                        </p>
