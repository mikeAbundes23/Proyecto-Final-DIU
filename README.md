...
Entrar a la carpeta ***Proyecto-Final-DIU***: `cd Proyecto-Final-DIU`.
...
Se encuentra en la siguiente página de [Neon](https://neon.tech/), donde con el ***correo:*** `trademaster233@gmail.com` y la ***contraseña:*** `TradeMaster23#DIU` se puede ver toda la estructura de la Base de Datos (para iniciar sesión, se debe ingresar como cuenta de Google).
...
2. Dentro del entorno virtual ya creado, ir dentro del directorio ***trade_master*** con  `cd trade_master`.
